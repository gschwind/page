...
public:
	...
	void notebook_close(shared_ptr<notebook_t> nbk);
	int  left_most_border();
	int  top_most_border();
	auto global_client_focus_history() -> list<weak_ptr<client_managed_t>>;
	auto net_client_list() -> list<shared_ptr<client_managed_t>>;
