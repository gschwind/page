...
box_int_t simple2_theme_t::compute_notebook_bookmark_position(
		box_int_t const & allocation) const {
	return box_int_t(allocation.x + allocation.w - 4 * 17 - 2, allocation.y + 2,
			16, 16);
}

box_int_t simple2_theme_t::compute_notebook_vsplit_position(
		box_int_t const & allocation) const {
...
box_int_t simple2_theme_t::compute_notebook_hsplit_position(
		box_int_t const & allocation) const {
...
box_int_t simple2_theme_t::compute_notebook_close_position(
		box_int_t const & allocation) const {
...
void simple2_theme_t::render_notebook_selected(
	...
	cairo_mask_surface(cr, close_button_s, ncclose.x, ncclose.y);
