...
//namespace page {
//
//struct popup_frame_move_t: public overlay_t {
//	page_context_t * _ctx;
//
//	icon64 * icon;
//	std::string title;
...
//
//public:
//	popup_frame_move_t(page_context_t * ctx) : _ctx{ctx}, _position { -1, -1, 1, 1 } {
//
//		icon = nullptr;
//		_has_alpha = true;
//		_is_durty = true;
...
//			_ctx->theme()->render_popup_move_frame(cr, icon, _position.w, _position.h, title);
//			cairo_restore(cr);
//		}
//	}
//
