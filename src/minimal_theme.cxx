...
box_int_t minimal_theme_layout_t::compute_floating_close_position(box_int_t const & _allocation) const {
	return box_int_t(_allocation.x + _allocation.w - 1 * 16 - 2, _allocation.y + 2, 16, 16);
}

box_int_t minimal_theme_layout_t::compute_floating_bind_position(box_int_t const & _allocation) const {
	return box_int_t(_allocation.x + _allocation.w - 2 * 16 - 2, _allocation.y + 2, 16, 16);
}
...
void minimal_theme_t::render_notebook(cairo_t * cr, notebook_t * n,
...

	{
		...
		box_int_t b(n->_allocation.x,
				n->_allocation.y + layout->notebook_margin.top - 4,
				layout->notebook_margin.left,
				n->_allocation.h - layout->notebook_margin.top + 4);
...

	{
		...
		box_int_t b(
				n->_allocation.x + n->_allocation.w
						- layout->notebook_margin.right,
				n->_allocation.y + layout->notebook_margin.top - 4,
				layout->notebook_margin.left,
				n->_allocation.h - layout->notebook_margin.top + 4);
...

	{
		...
		box_int_t b(n->_allocation.x + layout->notebook_margin.left,
				n->_allocation.y + layout->notebook_margin.top - 4,
				n->_allocation.w - layout->notebook_margin.left
						- layout->notebook_margin.right, 4);
...

	{
		...
		box_int_t b(n->_allocation.x + layout->notebook_margin.left,
				n->_allocation.y + n->_allocation.h - layout->notebook_margin.bottom,
				n->_allocation.w - layout->notebook_margin.left
						- layout->notebook_margin.right, 4);
